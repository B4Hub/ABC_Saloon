        ...
        <div class="row">
            <div class="col-xl-7 col-md-12 col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>Customer/Checkout" name="serviceform" id="serviceform" method="post">
                            <input type="hidden" name="customer_id" value="<?php echo $user_data->cust_id ?>">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="first-name-vertical">Branch :</label>
                                    <select class="form-select" name="branch" id="slot_branch">
                                        <option selected>Choose...</option>
                                        <?php foreach($branch as $b){?>
                                            <option value="<?php echo $b['branch_id']?>" <?php if($user_data->cust_branch ==$b['branch_id'] ) {echo "selected";} ?>><?php echo $b['branch_name']?>  :  <?php echo $b['city']?></option>
                                        <?php } ?> 
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" for="appointment_date">
                                        <input type="date" name="date" class="form-control" id="appointment_date" value="<?php echo date('Y-m-d') ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group" id="services-div">
                                    ...
                                    <select class=" form-select multiple-remove" name="services[]" id="services" multiple="multiple">
                                    <?php
                ...
                <div class="card mb-2 border border-primary border-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-8"><?=  $user_data->cust_name ?></div>
                        </div>
                ...
                <div class="card mb-2 border border-primary border-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <button class="btn btn-primary col-6" id="confirm-booking" type="button">Proceed to Pay</button>
                        </div>
                        
                        <!-- <div class="row mb-2">
                            <div class="col-12 text-end mt-2">
                                <button class="btn btn-primary" id="confirm-booking" type="button">Pay <i id="grand-amount"> ₹ 0  </i></button>
                            </div>
                        </div> -->
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(()=>{
        ...
        function getTimeSlots(){
            ...
            $('#slots').html('')
            $.ajax({
                url: '<?= base_url() ?>Customer/SlotsAndServices',
                method: 'POST',
        ...
        $('#confirm-booking').on('click',function(){
            ...
            $.ajax({
                url: '<?= base_url() ?>Customer/NewAppointment',
                method: 'POST',
                data:postData,
                success: (data)=>{
