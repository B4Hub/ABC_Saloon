...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li id="customers-li" class="sidebar-item  has-sub">
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item ">
                        <a href="<?php echo base_url() ?>Admin/AddCustomer">Add Customer</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="<?php echo base_url() ?>Admin/CustomersList">Customers List</a>
                    </li>
                </ul>
            </li>
            
            
            <!-- <li id="appointments-li"
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item ">
                        <a href="<?php echo base_url() ?>Admin/AddAppointment">Add Appointment</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="<?php echo base_url() ?>Admin/AppointmentsList">Appointments List</a>
                    </li>
                </ul>
            </li> -->
            ...
            <li id="alerts-li"
                class="sidebar-item ">
                <a href="<?php echo base_url() ?>Admin/Alerts" class='sidebar-link'>
            ...
            <li id="appointments-li"
                class="sidebar-item ">
                <a href="<?php echo base_url() ?>Admin/Appointments" class='sidebar-link'>
                <i class="bi bi-people-fill"></i>
                    <span>Appointments</span>
                </a>
            </li>
            ...
            <?php
            if($user_data->role_name == 'Super Admin'){
            ...
            <li id="monthly-report-li"
                class="sidebar-item  ">
                <a href="application-email.html" class='sidebar-link'>
                    <i class="bi bi-bar-chart-fill"></i>
                    <span>Montly Report</span>
                </a>
            </li>
