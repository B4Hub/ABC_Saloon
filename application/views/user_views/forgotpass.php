...
<div class="row h-100">
    <div class="col-lg-5 m-auto col-12">
        <div id="auth-left" class="text-center">
            ...
            <form id="code_form" action="<?php echo base_url() ?>Customer/resetpassword" method="post">
            ...
            <div class="text-center mt-5 text-lg fs-5">
                <p><a class="font-bold" href="<?php echo base_url()?>Customer/">Sign In</a></p>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#email_form button').on('click',function(e){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>Customer/requestCode',
                type: 'post',
                data: {email:email},
            ...
            $('#code_form button').on('click',function(e){
                ...
                $.ajax({
                    url: '<?php echo base_url() ?>Customer/resetpassword',
                    type: 'post',
                    ...
                    success: function(data){
                        if(data.status){
                            ...
                            $('#code_form button').attr('disabled',false);
                            $('#code_form button').html('Reset Password');
                            Toastify({
                                text: data.message,
                                duration: 10000,
                                destination: "",
