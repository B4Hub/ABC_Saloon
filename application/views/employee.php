...
<style>
    ...
    <section class="section">
                    ...
                    <form action="<?php echo base_url()?>Admin/EditCustomer" method="post">
                        ...
                        <form class="form form-horizontal">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title">Edit Employee Details
                                </h5>
            ...
            <div class="modal fade " id="Employee-details-modal" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                    role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Employee Details
                            </h5>
                            <button type="button" class="btn" data-bs-dismiss="modal"
                                aria-label="Close">
                                <i class="fa fa-close" data-feather="x"></i>
                        ...
                        <div class="modal-body">
                            <div class="profile-head d-flex align-items-center m-3">
                                ...
                                data-bs-target="#edit_modal" data-bs-dismiss="modal"> <i style="font-size:0.8rem;" class="fa fa-pencil"></i> Edit Employee</span>
                                </div>
                            ...
                            <div class="cust_details d-flex justify-content-between">
                                <div class="detail m-3 d-flex flex-column">
                                    <span class="text-dark">Employee ID</span>
                            ...
                            <h5 id="Employee_name_modal" class="text-center"></h5>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn text-danger me-auto"
                                ...
                                data-bs-target="#Employee-delete-modal">
                                <i class="bx bx-x d-block d-sm-none"></i>
                                <span class="d-none d-sm-block">Delete Employee</span>
                            </button>
            ...
            <div class="modal fade " id="Employee-delete-modal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="delete_title"class="modal-title text-danger">This Employee will be deleted !!
                            </h5>
                            <button type="button" class="btn" data-bs-dismiss="modal"
                                aria-label="Close">
                                <i class="fa fa-close" data-feather="x"></i>
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="<?php echo base_url() ?>Admin/DeleteEmployee" method="post">
                                ...
                                <button id="delete_Employee_btn" onclick="delete_Employee()" type="submit" class="btn btn-danger ml-1">
                                    <i class="bx bx-check d-block d-sm-none"></i>
            ...
            <div class="card">
                <div class="card-header d-flex">
                    ...
                    <div class="" style="margin-left:auto ;">
                        <a href="<?php echo base_url()?>Admin/AddEmployee" class="btn btn-primary">Add New Employee</a>
                    </div>
                </div>
                <div class="card-body">
...
const customer_details = (id)=>{
    ...
    let role = $('#customer'+id).data('role');
    let salary = $('#customer'+id).data('salary');
    $('#cust_name').text(name);
