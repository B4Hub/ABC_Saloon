                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="user-menu d-flex">
                                <div class="user-name text-end me-3">
                                    <h6 class="mb-0 text-gray-600"><?php echo $user_data->emp_name ?></h6>
                                    <p class="mb-0 text-sm text-gray-600"><?php echo $user_data->role_name ?></p>
                                </div>
                                <div class="user-img d-flex align-items-center">
                                    <div class="avatar avatar-md bg-warning me-3">
                                        <span class="avatar-content fs-5"><?php echo $user_data->emp_name[0] ?></span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                            <li>
                                <h6 class="dropdown-header">Hello, <?php echo explode(' ',$user_data->emp_name)[0] ?>!</h6>
                            </li>
