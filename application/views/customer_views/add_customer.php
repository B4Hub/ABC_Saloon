                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="button" id="cust_reg_btn" class="btn btn-primary me-1 mb-1">Register</button>
                                    <button type="reset"
            ...
            $('#cust_reg_btn').on('click',()=>{
                ...
                if(!testEmail.test(email)){
                    ...
                    if(!testMobile.test(mobile)){
                        ...
                        $.ajax({
                            url: '<?= base_url() ?>Admin/RegisterCustomer',
                            method: 'POST',
                            ...
                            success:(data)=>{
                                ...
                                if(data.status === 'registration_success'){
                                    top.location.href="http://localhost/ABC_Saloon/Admin/CustomersList"
                                }
                            }
                        })
                    }
